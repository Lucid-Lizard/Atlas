...
namespace Atlas.Content.Items.Hallow
{
    public class PixiePaddle : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<PixieBall>();
            Item.shootSpeed = 11f;
        ...
        {
            CreateRecipe(1)
                .AddIngredient(ItemID.PixieDust, 7)
        ...
        {
            Projectile.NewProjectile(source, position, new Vector2(0, -4), type, damage, knockback);
        ...
        public override void UseItemHitbox(Player player, ref Rectangle hitbox, ref bool noHitbox)
        {
            ...
            for (int i = 0; i < Main.maxProjectiles; i++)
            {
                ...
                if (p.active && p.ModProjectile is PongBall && Collision.CheckAABBvLineCollision(p.position, p.Hitbox.Size(), start, end) && player.altFunctionUse < 2)
                {
                    ...
                    Dust.NewDust(p.Center, 1, 1, DustID.Pixie, dust1.X, dust1.Y);
                    Dust.NewDust(p.Center, 1, 1, DustID.Pixie, dust2.X, dust2.Y);
